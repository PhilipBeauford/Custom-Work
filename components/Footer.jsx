        ...
        <div className="container px-6 py-4 mx-auto">
            <div className="lg:flex">
                <div className="w-full -mx-6 lg:w-2/5">
                    <div className="px-6">
                        <div>
                            <a href="#" className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Hot Brand</a>
                        </div>
                ...
                <div className="mt-6 lg:mt-0 lg:flex-1">
                    <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                        <div>
                            <h3 className="text-gray-700 font-bold uppercase dark:text-white">About</h3>
                        ...
                        <div>
                            <h3 className="text-gray-700 font-bold uppercase dark:text-white">Blog</h3>
                        ...
                        <div>
                            <h3 className="text-gray-700 font-bold uppercase dark:text-white">Products</h3>
                            <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Mega cloud</a>
                            <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Cloud Burst</a>
                            <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Cloud Facets</a>
                        </div>

                        <div>
                            <h3 className="text-gray-700 font-bold uppercase dark:text-white">Contact</h3>
            ...
            <div>
                <p className="text-center text-gray-800 dark:text-white">© Hot Brand 2020 - All rights reserved</p>
            </div>
        </div>
    </footer>
